...
def get_config():
    ...
    name = 'echonet_dynamic_uncond_uvit_FA_EC_MoE_greyscale_mid_4by4_l8r16_low16'
    config.seed = 1234
    ...
    config.nnet = d(
        ...
        tokens=int(low_freqs*112*112/(num_fa_repeats * num_fa_length * block_sz**2)),  # number of tokens to the network
    ...
    config.dataset = d(
        ...
        cache_name='cache_dct_fa_4by4_low16_l8r16_Y_bound',
